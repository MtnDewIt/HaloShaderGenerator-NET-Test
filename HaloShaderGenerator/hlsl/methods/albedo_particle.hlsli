...
float4 albedo_diffuse_plus_sprite_alpha(in float4 texcoord, in float3 alpha_tex, in float frame_blend, in float palettized_w)
{
    float4 albedo = 0;
...
float4 albedo_palettized_plus_sprite_alpha(in float4 texcoord, in float3 alpha_tex, in float frame_blend, in float palettized_w)
{
    float4 albedo = 0;
