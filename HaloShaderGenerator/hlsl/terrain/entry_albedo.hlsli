...
{	
	...
	float3 normal_3, normal_2, normal_1, normal_0;
    float4 albedo_3, albedo_2, albedo_1, albedo_0;
	...
	m_normal = normal_export(m_normal);
    PS_OUTPUT_ALBEDO output;
	output.diffuse = albedo;
	output.normal = float4(m_normal, albedo.a);
