#ifndef _HALOGRAM_PRT_HLSLI
#define _HALOGRAM_PRT_HLSLI
...
PS_OUTPUT_DEFAULT halogram_entry_static_sh(VS_OUTPUT_STATIC_SH input)
{
...
PS_OUTPUT_DEFAULT halogram_entry_static_prt(VS_OUTPUT_STATIC_PRT input)
{
    float4 albedo = float4(0, 0, 0, 1);
