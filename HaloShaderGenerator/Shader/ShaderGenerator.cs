    ...
    public class ShaderGenerator : IShaderGenerator
    {
        ...
        public ShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            TemplateGenerator.TemplateGenerator.CreateGlobalMacros(macros, Globals.ShaderType.Shader, entryPoint,
                ...
                Shared.Alpha_Blend_Source.From_Albedo_Alpha_Without_Fresnel, ApplyFixes);
        ...
        public ShaderGeneratorResult GenerateSharedPixelShader(ShaderStage entryPoint, int methodIndex, int optionIndex)
        {
            ...
            TemplateGenerator.TemplateGenerator.CreateGlobalMacros(macros, Globals.ShaderType.Shader, entryPoint,
                Shared.Blend_Mode.Opaque, Misc.First_Person_Never, alphaTestOption, Shared.Alpha_Blend_Source.From_Albedo_Alpha_Without_Fresnel, false);
        ...
        public ShaderGeneratorResult GenerateSharedVertexShader(VertexType vertexType, ShaderStage entryPoint)
        {
            ...
            TemplateGenerator.TemplateGenerator.CreateGlobalMacros(macros, Globals.ShaderType.Shader, entryPoint,
                Shared.Blend_Mode.Opaque, Misc.First_Person_Never, Shared.Alpha_Test.None, Shared.Alpha_Blend_Source.From_Albedo_Alpha_Without_Fresnel, false, true, vertexType);
