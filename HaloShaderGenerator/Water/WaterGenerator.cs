...
namespace HaloShaderGenerator.Water
{
    public class WaterGenerator : IShaderGenerator
    {
        ...
        public ShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            TemplateGenerator.TemplateGenerator.CreateGlobalMacros(macros, ShaderType.Water, entryPoint, Shared.Blend_Mode.Opaque, Shader.Misc.First_Person_Never, ApplyFixes);
