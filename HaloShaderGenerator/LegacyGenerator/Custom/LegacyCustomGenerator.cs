...
namespace HaloShaderGenerator.LegacyGenerator.Custom
{
    public class LegacyCustomGenerator : IShaderGenerator
    {
        ...
        /// </summary>
        public LegacyCustomGenerator(bool applyFixes = false) { TemplateGenerationValid = false; ApplyFixes = applyFixes; }

        /// <summary>
        /// Generator instantiation for method specific shaders.
        /// </summary>
        public LegacyCustomGenerator(Albedo albedo, Bump_Mapping bump_mapping, Alpha_Test alpha_test, Specular_Mask specular_mask, Material_Model material_model,
        ...
        public LegacyCustomGenerator(byte[] options, bool applyFixes = false)
        {
        ...
        public LegacyShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shadertype", Shared.ShaderType.Custom, "shadertype_"));

            // prevent crash
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Shared.Distortion>());
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("distortion_arg", "Off", "k_distortion_"));
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Shared.Soft_Fade>());
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("soft_fade_arg", Shared.Soft_Fade.Off, "k_soft_fade_"));

            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"pixl_custom.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedVertexShader(VertexType vertexType, ShaderStage entryPoint)
        {
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource(@"glvs_custom.hlsl", macros, $"entry_{entryPoint.ToString().ToLower()}", "vs_3_0");
