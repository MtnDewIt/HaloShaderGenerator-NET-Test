...
namespace HaloShaderGenerator.LegacyGenerator.Contrail
{
    public class LegacyContrailGenerator : IShaderGenerator
    {
        ...
        /// </summary>
        public LegacyContrailGenerator(bool applyFixes = false) { TemplateGenerationValid = false; ApplyFixes = applyFixes; }

        /// <summary>
        /// Generator instantiation for method specific shaders.
        /// </summary>
        public LegacyContrailGenerator(Albedo albedo, Blend_Mode blend_mode, Black_Point black_point, Fog fog, bool applyFixes = false)
        {
            this.albedo = albedo;
        ...
        public LegacyContrailGenerator(byte[] options, bool applyFixes = false)
        {
        ...
        public LegacyShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("black_point", sBlackPoint, "black_point_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("fog", sFog, "fog_"));

            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shaderstage", entryPoint, "k_shaderstage_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shadertype", Shared.ShaderType.Contrail, "k_shadertype_"));
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"pixl_contrail.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedPixelShader(ShaderStage entryPoint, int methodIndex, int optionIndex)
        {
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"glps_contrail.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedVertexShader(VertexType vertexType, ShaderStage entryPoint)
        {
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource(@"glvs_contrail.hlsl", macros, $"entry_{entryPoint.ToString().ToLower()}", "vs_3_0");
