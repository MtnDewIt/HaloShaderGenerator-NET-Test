...
namespace HaloShaderGenerator.LegacyGenerator.Generator
{
    public interface IShaderGenerator
    {
        ...
        /// <param name="entryPoint"></param>
        /// <returns></returns>
        LegacyShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint);
        ...
        /// <returns></returns>
        LegacyShaderGeneratorResult GenerateSharedPixelShader(ShaderStage entryPoint, int methodIndex, int optionIndex);
        ...
        /// <param name="entryPoint"></param>
        /// <returns></returns>
        LegacyShaderGeneratorResult GenerateVertexShader(VertexType vertexType, ShaderStage entryPoint);
        ...
        /// <param name="entryPoint"></param>
        /// <returns></returns>
        LegacyShaderGeneratorResult GenerateSharedVertexShader(VertexType vertexType, ShaderStage entryPoint);
