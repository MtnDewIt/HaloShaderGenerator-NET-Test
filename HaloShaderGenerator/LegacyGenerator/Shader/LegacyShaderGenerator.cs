...
namespace HaloShaderGenerator.LegacyGenerator.Shader
{
    public class LegacyShaderGenerator : IShaderGenerator
    {
        ...
        /// </summary>
        public LegacyShaderGenerator(bool applyFixes = false) { TemplateGenerationValid = false; ApplyFixes = applyFixes; }

        /// <summary>
        /// Generator instantiation for method specific shaders.
        /// </summary>
        public LegacyShaderGenerator(Albedo albedo, Bump_Mapping bump_mapping, Alpha_Test alpha_test, Specular_Mask specular_mask, Material_Model material_model,
        ...
        public LegacyShaderGenerator(byte[] options, bool applyFixes = false)
        {
        ...
        public LegacyShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Specular_Mask>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Shared.Material_Model>());
            ...
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Parallax>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Misc>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Shared.Distortion>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Shared.Soft_Fade>());
            ...
            if (material_model == Material_Model.Cook_Torrance_Odst)
            {
                ...
                macros.Add(LegacyShaderGeneratorBase.CreateMacro("ODST_COOK_TORRANCE", 1));
            }
            else
            {
            ...
            if (albedo == Albedo.Constant_Color)
                macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_albedo_vs", sAlbedo, "calc_albedo_", "_vs"));

            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_bumpmap_ps", bump_mapping, "calc_bumpmap_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_bumpmap_vs", bump_mapping, "calc_bumpmap_", "_vs"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_alpha_test_ps", sAlphaTest, "calc_alpha_test_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_specular_mask_ps", specular_mask, "calc_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_self_illumination_ps", sSelfIllumination, "calc_self_illumination_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_parallax_ps", parallax, "calc_parallax_", "_ps"));

            switch (parallax)
            {
                case Parallax.Simple_Detail:
                    macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_parallax_vs", Parallax.Simple, "calc_parallax_", "_vs"));
                    break;
                default:
                    macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_parallax_vs", parallax, "calc_parallax_", "_vs"));
                    break;
            }

            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_material_analytic_specular", sMaterialModel, "calc_material_analytic_specular_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_material_area_specular", sMaterialModel, "calc_material_area_specular_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_lighting_ps", sMaterialModel, "calc_lighting_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_dynamic_lighting_ps", sMaterialModel, "calc_dynamic_lighting_", "_ps"));

            macros.Add(LegacyShaderGeneratorBase.CreateMacro("material_type", sMaterialModel, "material_type_"));
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shadertype", Shared.ShaderType.Shader, "k_shadertype_"));

            macros.Add(LegacyShaderGeneratorBase.CreateMacro("albedo_arg", sAlbedo, "k_albedo_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("material_type_arg", sMaterialModel, "k_material_model_"));
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("misc_arg", misc, "k_misc_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("distortion_arg", distortion, "k_distortion_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("soft_fade_arg", soft_fade, "k_soft_fade_"));

            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"pixl_shader.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedPixelShader(ShaderStage entryPoint, int methodIndex, int optionIndex)
        {
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"glps_shader.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedVertexShader(VertexType vertexType, ShaderStage entryPoint)
        {
            ...
            if (MS30)
                macros.Add(LegacyShaderGeneratorBase.CreateMacro("MS30_SHADER", 1));
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shadertype", Shared.ShaderType.Shader, "shadertype_"));

            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource(@"glvs_shader.hlsl", macros, $"entry_{entryPoint.ToString().ToLower()}", "vs_3_0");
