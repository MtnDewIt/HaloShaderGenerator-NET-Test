...
namespace HaloShaderGenerator.LegacyGenerator.Beam
{
    public class LegacyBeamGenerator : IShaderGenerator
    {
        ...
        /// </summary>
        public LegacyBeamGenerator(bool applyFixes = false) { TemplateGenerationValid = false; ApplyFixes = applyFixes; }

        /// <summary>
        /// Generator instantiation for method specific shaders.
        /// </summary>
        public LegacyBeamGenerator(Albedo albedo, Blend_Mode blend_mode, Black_Point black_point, Fog fog, bool applyFixes = false)
        {
            this.albedo = albedo;
        ...
        public LegacyBeamGenerator(byte[] options, bool applyFixes = false)
        {
        ...
        public LegacyShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shadertype", Shared.ShaderType.Beam, "k_shadertype_"));
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"pixl_beam.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedPixelShader(ShaderStage entryPoint, int methodIndex, int optionIndex)
        {
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"glps_beam.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedVertexShader(VertexType vertexType, ShaderStage entryPoint)
        {
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource(@"glvs_beam.hlsl", macros, $"entry_{entryPoint.ToString().ToLower()}", "vs_3_0");
