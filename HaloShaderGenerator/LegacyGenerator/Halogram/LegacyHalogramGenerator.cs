...
namespace HaloShaderGenerator.LegacyGenerator.Halogram
{
    public class LegacyHalogramGenerator : IShaderGenerator
    {
        ...
        /// </summary>
        public LegacyHalogramGenerator(bool applyFixes = false) { TemplateGenerationValid = false; ApplyFixes = applyFixes; }

        /// <summary>
        /// Generator instantiation for method specific shaders.
        /// </summary>
        public LegacyHalogramGenerator(Albedo albedo, Self_Illumination self_illumination, Blend_Mode blend_mode, Misc misc, Warp warp, Overlay overlay, 
        ...
        public LegacyHalogramGenerator(byte[] options, bool applyFixes = false)
        {
        ...
        public LegacyShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Overlay>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Edge_Fade>());
            ...
            switch (self_illumination)
            {
                ...
                case Self_Illumination.Ml_Add_Five_Change_Color:
                    ...
                    macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_self_illumination_ps", Shared.Self_Illumination.Multilayer_Additive, "calc_self_illumination_", "_ps"));
                    break;
                case Self_Illumination.Palettized_Plasma_Change_Color:
                    // Palettized_Plasma_Change_Color use Palettized_Plasma ps code
                    macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_self_illumination_ps", Shared.Self_Illumination.Palettized_Plasma, "calc_self_illumination_", "_ps"));
                    break;
                default:
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_warp", warp, "calc_warp_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_overlay_ps", overlay, "calc_overlay_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_edge_fade_ps", edge_fade, "calc_edge_fade_", "_ps"));

            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shaderstage", entryPoint, "k_shaderstage_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shadertype", Shared.ShaderType.Halogram, "k_shadertype_"));
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("warp_arg", warp, "k_warp_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("overlay_arg", overlay, "k_overlay_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("edge_fade_arg", edge_fade, "k_edge_fade_"));
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("_HALOGRAM", 1));

            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"pixl_halogram.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedPixelShader(ShaderStage entryPoint, int methodIndex, int optionIndex)
        {
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"glps_halogram.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedVertexShader(VertexType vertexType, ShaderStage entryPoint)
        {
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shadertype", Shared.ShaderType.Halogram, "shadertype_"));

            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource(@"glvs_halogram.hlsl", macros, $"entry_{entryPoint.ToString().ToLower()}", "vs_3_0");
