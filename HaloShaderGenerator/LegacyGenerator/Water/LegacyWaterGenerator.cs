...
namespace HaloShaderGenerator.LegacyGenerator.Water
{
    public class LegacyWaterGenerator : IShaderGenerator
    {
        ...
        public LegacyWaterGenerator(bool applyFixes = false) { TemplateGenerationValid = false; ApplyFixes = applyFixes; }

        public LegacyWaterGenerator(Waveshape waveshape, Watercolor watercolor, Reflection reflection, Refraction refraction, 
        ...
        public LegacyWaterGenerator(byte[] options, bool applyFixes = false)
        {
        ...
        public LegacyShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Waveshape>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Watercolor>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Reflection>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Refraction>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Bankalpha>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Appearance>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Global_Shape>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Foam>());
            macros.AddRange(LegacyShaderGeneratorBase.CreateMethodEnumDefinitions<Reach_Compatibility>());
            ...
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("shadertype", Shared.ShaderType.Water, "k_shadertype_"));

            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_waveshape_ps", waveshape, "calc_waveshape_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_watercolor_ps", watercolor, "calc_watercolor_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_reflection_ps", reflection, "calc_reflection_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_refraction_ps", refraction, "calc_refraction_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_bankalpha_ps", bankalpha, "calc_bankalpha_", "_ps"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("calc_foam_ps", foam, "calc_foam_", "_ps"));

            macros.Add(LegacyShaderGeneratorBase.CreateMacro("waveshape_arg", waveshape, "k_waveshape_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("watercolor_arg", watercolor, "k_watercolor_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("reflection_arg", reflection, "k_reflection_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("refraction_arg", refraction, "k_refraction_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("bankalpha_arg", bankalpha, "k_bankalpha_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("appearance_arg", appearance, "k_appearance_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("global_shape_arg", global_shape, "k_global_shape_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("foam_arg", foam, "k_foam_"));
            macros.Add(LegacyShaderGeneratorBase.CreateMacro("reach_compatibility_arg", reach_compatibility, "k_reach_compatibility_"));

            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource($"pixl_water.hlsl", macros, "entry_" + entryPoint.ToString().ToLower(), "ps_3_0");
        ...
        public LegacyShaderGeneratorResult GenerateSharedVertexShader(VertexType vertexType, ShaderStage entryPoint)
        {
            ...
            byte[] shaderBytecode = LegacyShaderGeneratorBase.GenerateSource(@"glvs_water.hlsl", macros, $"entry_{entryPoint.ToString().ToLower()}", "vs_3_0");
