...
namespace HaloShaderGenerator.Contrail
{
    public class ContrailGenerator : IShaderGenerator
    {
        ...
        public ShaderGeneratorResult GeneratePixelShader(ShaderStage entryPoint)
        {
            ...
            macros.Add(ShaderGeneratorBase.CreateMacro("contrail_albedo", albedo, "albedo_"));
            macros.Add(ShaderGeneratorBase.CreateMacro("contrail_blend_mode", blend_mode, "blend_mode_"));
            macros.Add(ShaderGeneratorBase.CreateMacro("contrail_black_point", black_point, "black_point_"));
            macros.Add(ShaderGeneratorBase.CreateMacro("contrail_fog", fog, "fog_"));
            ...
            macros.Add(ShaderGeneratorBase.CreateMacro("contrail_albedo_arg", albedo, "k_contrail_albedo_"));
            macros.Add(ShaderGeneratorBase.CreateMacro("contrail_blend_type_arg", blend_mode, "k_contrail_blend_mode_"));
