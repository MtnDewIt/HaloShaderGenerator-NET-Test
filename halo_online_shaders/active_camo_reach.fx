...
{
	perturb.x= dot(vertex.normal, Camera_Left);		// technically we should do this dot product after transformation, to put the distortion in world space, but it's not that obvious and this lets us skip the entire normal transformation
